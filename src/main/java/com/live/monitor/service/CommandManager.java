...
import com.live.monitor.ffmpeg.commandbuidler.CommandAssembly;
import com.live.monitor.ffmpeg.commandbuidler.CommandBuidler;
import com.live.monitor.config.ProgramConfig;
import com.live.monitor.ffmpeg.data.CommandTasker;
import com.live.monitor.ffmpeg.data.TaskDao;
import com.live.monitor.ffmpeg.handler.TaskHandler;

import java.util.Collection;
import java.util.Map;

import static com.live.monitor.utils.PropertiesUtil.load;
...
public interface CommandManager {
	...
	public static final ProgramConfig config=load("./properties/loadFFmpeg.properties", ProgramConfig.class);
	/**
	 * 注入自己实现的持久层
	 * 
	 * @param taskDao
